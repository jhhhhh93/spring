...
// @Test 메서드가 실행되기 전에 제공한 조립 설명서를 바탕으로 스프링 컨테이너를 구축
...
public class SpringContainerTest {
	...
	// boardDaoP 스프링 빈 prototype scope
	@Resource(name="boardDaoP")
	private IBoardDao boardDaoP1;
	@Resource(name="boardDaoP")
	...
	*/
	...
	public void springBeanScopeTest() {
		...
		// 디자인 패턴 관점에서 보면 boardDaoS1과 boardDaoS2는 같은 클래스로부터 생성되었으므로
		...
		assertNotEquals(boardDaoP1, boardDaoP2);
	}
