...
//		"classpath:kr/or/ddit/config/spring/servlet-context.xml"}) // controller scan : servlet-context.xml
@ContextConfiguration(classes = {RootConfig.class, DatasourceConfigTest.class, ServletConfig.class})
